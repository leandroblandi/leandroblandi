# 💫 About Me
<strong>Software Development Student</strong> at Universidad Nacional de Lanús (UNLa). Passionate about new technologies and programming.<br><strong>I am a self-taught Trainee Web Developer</strong>, that wants to learn and grow professionally to offer proffesional products.<br>Looking for my first job, open to any part time job opportunity.
